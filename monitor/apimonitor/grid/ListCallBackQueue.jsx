...
const LIST_URL=URI.CORE_ASYNCQUEUE.list+"?status=1";
...
class ListCallBackQueue extends React.Component {
  constructor(props) {
    super(props);
    this.state={
  ...
  runSelectedQueue=()=>{
    ...
    AjaxUtils.post(RUNSelected_URL,{ids:ids},(data)=>{
          ...
          if(data.state===false){
            ...
            AjaxUtils.showInfo("成功调度("+data.msg+")个队列!");
          }
    });
  }
...
export default ListCallBackQueue;
