...
const LIST_URL=CURURI.WORKFLOW_FRONTEND.ListDoneDocs;
const RunProcess=CURURI.WORKFLOW_FRONTEND.RunProcess;

//我的已办

class ListDoneDocs extends React.Component {
  constructor(props) {
    super(props);
    this.url=LIST_URL;
    this.state={
 ...
 undo=()=>{
   ...
   AjaxUtils.ajax(RunProcess,{WF_DocUnid:docUnid,WF_Processid:processId,WF_Action:'undo'},"POST","html",null,(data)=>{
      ...
      <div style={{minHeight:600}}>
            <Row style={{marginBottom:5}} gutter={0} >
              <Col span={12} >
                ...
                <Button  type="ghost" onClick={AjaxUtils.showConfirm.bind(this,"尝试收回流程","确定收回已经办理过的流程吗?",this.undo)} icon="undo"  loading={loading}  disabled={!hasSelected}  >尝试收回</Button> {' '}
              </Col>
              <Col span={12}>
