...
const LIST_URL=CURURI.WORKFLOW_FRONTEND.ListDraftDocs;
const RunProcess=CURURI.WORKFLOW_FRONTEND.RunProcess;

//我的草稿箱

class ListDraftDocs extends React.Component {
  constructor(props) {
    super(props);
    this.url=LIST_URL;
    this.state={
 ...
 openProcess=(orUnid,taskId)=>{
   let url=CURURI.workflowHost+"/r?wf_num=R_S003_B036&wf_docunid="+orUnid;
   window.open(url);
 }
 ...
 unPause=()=>{
   ...
   AjaxUtils.ajax(RunProcess,{WF_DocUnid:docUnid,WF_Processid:processId,WF_Action:'UnPause'},"POST","html",null,(data)=>{
      ...
      <div style={{minHeight:600}}>
            <Row style={{marginBottom:5}} gutter={0} >
              <Col span={12} >
                ...
                <Button  type="ghost" onClick={AjaxUtils.showConfirm.bind(this,"恢复流程","确定恢复选中的流程吗?",this.unPause)} icon="redo"  loading={loading}  disabled={!hasSelected}  >恢复流程</Button> {' '}
              </Col>
              <Col span={12}>
