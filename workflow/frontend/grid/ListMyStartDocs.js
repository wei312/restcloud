...
const LIST_URL=CURURI.WORKFLOW_FRONTEND.ListMyStartDocs;
const RunProcess=CURURI.WORKFLOW_FRONTEND.RunProcess;

//我申请的

class ListMyStartDocs extends React.Component {
  constructor(props) {
    super(props);
    this.url=LIST_URL;
    this.state={
 ...
 pause=()=>{
   ...
   AjaxUtils.ajax(RunProcess,{WF_DocUnid:docUnid,WF_Processid:processId,WF_Action:'Pause'},"POST","html",null,(data)=>{
      ...
      <div style={{minHeight:600}}>
            <Row style={{marginBottom:5}} gutter={0} >
              <Col span={12} >
                ...
                <Button  type="ghost" onClick={AjaxUtils.showConfirm.bind(this,"暂停流程","确定暂停选中的流程吗?",this.pause)} icon="pause"  loading={loading}  disabled={!hasSelected}  >暂停流程</Button> {' '}
              </Col>
              <Col span={12}>
...
export default ListMyStartDocs;
