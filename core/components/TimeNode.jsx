...
const PropsUrl=URI.CORE_DAAS_PROCESSNODE.props;
const SubmitUrl=URI.CORE_DAAS_PROCESSNODE.save; //存盘地址
        ...
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
            ...
            <FormItem
              ...
              wrapperCol={{ span: 16 }}
            >{
              getFieldDecorator('second',{rules: [{ required: true}],initialValue:60})
              (<InputNumber min={1}  />)
              }
            </FormItem>
            <FormItem
