...
//home page
class APIIndexLayoutForInner extends React.Component {
  constructor(props) {
    super(props);
    this.appId='';
  ...
  render(){
    ...
    const settingMenu=(<Menu style={{float:'right',fontSize:'16px',padding:0}}  onClick={this.handleClick}  >
                  <Menu.Item key="Desinger" style={{fontSize:'14px'}} ><Icon type="edit" />服务开发</Menu.Item>
    ...
    if(menuId==='home'){
      ...
      this.state.menuNodeObj.menuPath=this.appId+"JSON常量";
...
export default APIIndexLayoutForInner;
