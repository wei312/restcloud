...
class ListConfigLog extends React.Component {
  constructor(props) {
    super(props);
    this.searchFilters={};
    this.state={
  ...
  render(){
    ...
    const columns=[{
      ...
      render:(text,record)=>{
        ...
        render:(text,record)=>{
          return <a  >
           <Popconfirm title="确定恢复?" onConfirm={this.recover.bind(this,record)}>恢复</Popconfirm>
          </a>
        }
      }];
      ...
      <div style={{minHeight:'600px'}} >
        <Row style={{marginBottom:5}} gutter={0} >
          <Col span={12} >
              ...
              <Button  type="ghost" onClick={AjaxUtils.showConfirm.bind(this,"清空日记","确定要清空所有日记记录吗?",this.clear)} icon="check"   >清空日记</Button>{' '}
